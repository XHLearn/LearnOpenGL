...
int main()
{
    ...
    Shader shader("src/4-AdvancedOpenGL/2-Stenciltesting/1-one.vs", "src/4-AdvancedOpenGL/2-Stenciltesting/1-one.fs");
    Shader singleShader("src/4-AdvancedOpenGL/2-Stenciltesting/1-one.vs", "src/4-AdvancedOpenGL/2-Stenciltesting/SingleColor.fs");
    shader.use();
